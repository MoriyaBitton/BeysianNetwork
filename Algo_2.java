...
public class Algo_2 {
    ...
    public Algo_2(Variable _my_var, String _my_values, ArrayList<Evidence> _my_evi_list, VariablesStorage _my_var_storage) {
        this._var_q = _my_var;
    ...
    public Answer run() {
        ...
        // Join factors by eliminate system; algo 2 case: ASCII of hidden vars name
...
//                            System.out.println();
    ...
    private Factor joinFactors(HashMap<String, Factor> all_factors, ArrayList<Variable> vars_hidden_array) {
        // by hidden
        // join two factors for each time
        Collections.sort(vars_hidden_array, (a, b) -> String.CASE_INSENSITIVE_ORDER.compare(a.getName(), b.getName())); //sorted my hidden var list by names
